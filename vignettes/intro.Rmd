...
![Tofmes (Crested tit)](https://upload.wikimedia.org/wikipedia/commons/8/87/Crested_tit_%288750219915%29.jpg)
...
```{r taxtree, fig.height=6, fig.width=8, message=FALSE}
library(phytools)
...
```{r grid_plot, message=FALSE, warning=FALSE, fig.width=6, fig.height=6}
