---
title: "Instroduction to sbdi4r2 v.1.0.0"
date: "`r Sys.Date()`"
output: 
  rmarkdown::html_vignette:
    ...
    fig_caption: TRUE
vignette: >
  %\VignetteIndexEntry{Introduction to sbdi4r2 v.1.0.0}
...
sx$Species <- as.factor(sx$Species)

## create phylo object of canonical name nested within Genus
ax <- as.phylo(~Genus/Species, data = sx)
...
x <- sbdi_call() |>
  ...
  select(recordID, scientificName, taxonConceptID, taxonRank, 
         ...
         eventDate, occurrenceStatus, env_layers) |> 
  atlas_occurrences()
```
